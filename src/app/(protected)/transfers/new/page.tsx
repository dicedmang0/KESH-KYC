...
export default function NewTransferPage() {
  ...
  const amountError =
    !Number.isFinite(amountNum) || amountNum < TRANSFER_MIN_AMOUNT
      ...
      : amountNum > effectiveMaxAmount
        ? selectedSenderIsWic
          ? 'Walk-In Customer (WIC) memiliki limit transaksi maksimal Rp100.000.000.'
            ...
            <div className="mt-1 rounded-lg border bg-slate-50 p-3 space-y-2">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium font-mono">
                    {selectedSenderIsWic ? 'WIC - Tanpa CIF' : formatCif(selectedSender.cif_no)}
                  </div>
                </div>
                <div>
              ...
              {selectedSenderIsWic && (
                <div className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
                  Walk-In Customer (WIC) tidak memiliki CIF dan limit transaksi maksimal Rp100.000.000.
                </div>
              )}
          ...
          <div className="col-span-1">
            ...
            {amountError ? (
              ...
              <p className="mt-1 text-xs text-slate-400">
                {selectedSenderIsWic ? 'Rp10.000 – Rp100.000.000 untuk WIC' : 'Rp10.000 – Rp500.000.000'}
              </p>
            )}
          </div>
          <div className="col-span-1">
